...
\draw[thin,-stealth, blue] (0,0,0) -- (\xonex,\yp,0) node[below, pos=0.8] {$X_1 \widehat{\beta_\mathcal{F}}_1^T$};
\draw[thin,-stealth, blue] (\xonex,\yp,0) -- (\xp,\yp,0) node[below, pos=0.5] {$X_0 \widehat{\beta_\mathcal{F}}_0^T$};

% show the null model
\draw[thin,-stealth, purple] (0,0,0) -- (\xp,0,0) node[below, pos=0.5] {$X_1 \widehat{\beta_\mathcal{N}}^T$};
...
\draw[thick,-stealth,red] (\xp,\yp,0) -- (Y) node[right, pos=0.4] {
    \small $\widehat{\mathcal{E}_{\mathcal{F} }}$
    };
% null epsilon
\draw[thin,-stealth, red] (\xp,0,00) -- (\xp,\yp,\zp) node[left, pos=0.5] {
    \small $\widehat{\mathcal{E}_{\mathcal{N}}} $
    };
% difference
\draw[very thin,-stealth, red] (\xp,0,00) -- (\xp,\yp,0) node[right, pos=0.25] {
    \small $\widehat{\mathcal{E}_{\mathcal{N}}} - \widehat{\mathcal{E}_{\mathcal{F}}}$
    };

% Projection on the plane 
\filldraw[blue] (\xp,\yp,0) circle (1pt) node[right] {$X \widehat{\beta_{\mathcal{F}}}^T$};
